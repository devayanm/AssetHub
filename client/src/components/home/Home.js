    ...
    const cities = cityNames.map(async (city) => {
      try {
        const response = await fetch(
          `https://source.unsplash.com/featured/?${city}&query=city`
        );
        return {
          name: city,
          image: response.url,
    ...
    <>
      <div className="hero container-fluid mb-3">
        ...
        >
          <Carousel.Item>
            ...
            <Carousel.Caption className="text-start d-md-flex align-items-md-center justify-content-md-start h-100">
              <div
                className="bg-white bg-opacity-50 p-4 rounded-start text-left"
                style={{
              ...
              >
                <h1 className="text-dark fw-bold mb-3 display-5">
                  Mere Paas to
                </h1>
                <h2 className="text-dark fw-bold mb-3 display-6">
                  Ghar hai, Gadi Hai, Zameen Hai
                </h2>
                <h3 className="text-dark mb-3 display-7">
                  Tumhare Paas Kya Hai, Hain...
                </h3>
                <Link to="/explore">
        ...
        <style jsx>{`
          ...
          @media (max-width: 440px) and (min-width: 280px) {
            .carousel-caption h1 {
              font-size: 0.95rem;
            }
            .carousel-caption h2 {
      ...
      <Container className="py-5">
        <h2 className="mb-4 text-center" style={{ color: "#4CAF50" }}>
          Trending Cities for Buying/Selling Assets
        </h2>
        <Slider {...settings}>
      ...
      <Container className="py-5">
        <Row className="mb-5">
          <Col md={12} className="text-center">
            <h1 className="display-4 mb-4" style={{ color: "#4CAF50" }}>
              Welcome to AssetHub
            </h1>
            <p
              className="lead mb-4"
            ...
            >
              ...
              renting, and auctioning properties, cars, and land. Whether you're
              a property owner, renter, or investor, AssetHub has the tools you
              need to streamline your transactions and maximize your returns.
            </p>
            <p
              className="lead mb-5"
              style={{ fontSize: "1.2rem", color: "#555" }}
            >
              ...
              managing your assets and unlocking new opportunities in the real
              estate market.
            </p>
          </Col>
        </Row>
        <Row className="mb-5">
          <Col md={4} className="mb-3">
            <Card className="h-100 shadow">
              <Card.Body>
                <h3 className="card-title" style={{ color: "#4CAF50" }}>
                  Efficiency
                </h3>
            ...
            {authenticated ? (
              <>
                <p
                  ...
                  style={{ fontSize: "1.2rem", color: "#555" }}
                >
                  Go to your personalized dashboard to experience the power of
                  AssetHub.
                </p>
                <Link to="/dashboard">
