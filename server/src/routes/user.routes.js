...
import { getAllAdvs, getAdvById, newAdv, deleteAdv } from "../controllers/adv.controller.js"
...
router.route("/newAd").post(verifyJWT, upload.array("thumbnails"),upload.single("adVid"), newAdv)
